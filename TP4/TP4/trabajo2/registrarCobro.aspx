<%@ Page Language="C#" AutoEventWireup="true" CodeFile="registrarCobro.aspx.cs" Inherits="trabajo2_registrarCobro" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Panel ID="Panel2" runat="server" BorderStyle="Solid" BorderWidth="2px" Height="501px" HorizontalAlign="Center">
            ...
            <br />
            <br />
            <asp:HyperLink ID="volverHL" runat="server" NavigateUrl="~/trabajo2/inicio2.aspx">Ir a página principal</asp:HyperLink>
        </asp:Panel>
    </form>
</body>
</html>
